...
public class ItemImagesDAO {
    ...
    public int saveItemImage(ItemImage itemImage)
    {
        ...
        String insertItemCategory = "INSERT INTO "
                ...
                + ItemImage.GIDB_IMAGE_ID + ","
                + ItemImage.GIDB_SERVICE_URL + ","
        ...
        try {
            ...
            statement.setObject(++i,itemImage.getGidbImageID());
            statement.setString(++i,itemImage.getGidbServiceURL());
